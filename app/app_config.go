...
import (
	...
	_ "github.com/planetmint/planetmint-go/x/machine/module" // import for side-effects

	machinemodulev1 "github.com/planetmint/planetmint-go/api/planetmintgo/machine/module"
...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   machinemoduletypes.ModuleName,
				Config: appconfig.WrapAny(&machinemodulev1.Module{}),
			},
