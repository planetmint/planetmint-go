...
type PoPDistribution struct {
	...
	FirstPop   int64  `protobuf:"varint,2,opt,name=firstPop,proto3" json:"firstPop,omitempty"`
	LastPop    int64  `protobuf:"varint,3,opt,name=lastPop,proto3" json:"lastPop,omitempty"`
}
...
func (m *PoPDistribution) GetFirstPop() int64 {
	if m != nil {
		return m.FirstPop
	}
	return 0
...
func (m *PoPDistribution) GetLastPop() int64 {
	if m != nil {
		return m.LastPop
	}
	return 0
...
var fileDescriptor_456968989719b0d9 = []byte{
	...
	0x8b, 0x23, 0x2d, 0xb3, 0xa8, 0xb8, 0x24, 0x20, 0xbf, 0x40, 0x82, 0x49, 0x81, 0x51, 0x83, 0x39,
	...
	0x00, 0xff, 0xff, 0x3a, 0x5c, 0x83, 0xc3, 0xf8, 0x00, 0x00, 0x00,
}
